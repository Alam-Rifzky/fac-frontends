...
<div class="container-fluid p-1 text-white text-center" style="background: #003a75">
    <?php include_once $data->homedir . 'view/aolintegration/fragments/headertwo.php'; ?>
</div>

<?php if (count($data->reqaccess) > 0): ?>

    <div>
        <?php include_once $data->homedir . 'view/aolintegration/fragments/carousel.php'; ?>
    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <a class="navbar-brand" href="<?= $data->base_url ?>">
                        <img src="<?= $data->base_url ?>medias/images/figma-asset2.png" class="img-fluid"
                             alt="cta image">
                    </a>
                </div>
                <!-- Right: Price Card -->
